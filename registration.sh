#!/bin/sh
# =============================================================================
# Bash script that uses FSL to process human brain MRI into MNI template
# Output is of dimensions [182 x 281x 182]
# use the preprocess.py to further normalize the data for Deep Learning model
# =============================================================================
# Usage: 	for X in $(ls PTHnii); 
# 			do bash registration.sh non_registered_nii/ $X $PWD/registered_nii; done

export FSLOUTPUTTYPE='NIFTI'

# $1 is the folder of the raw data, 
# $2 is the filename of the raw data, 
# $3 is output folder to save processed data
...
${FSLDIR}/bin/flirt -in T1_brain.nii -ref $FSLDIR/data/standard/MNI152_T1_2mm_brain -omat orig_to_MNI.mat
...
${FSLDIR}/bin/flirt -in T1.nii -ref $FSLDIR/data/standard/MNI152_T1_2mm_brain -applyxfm -init orig_to_MNI.mat -out T1_MNI.nii
